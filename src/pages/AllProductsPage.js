      ...
      <section className="py-10 px-4 md:px-8 bg-white font-poppins">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-2">
                <label htmlFor="category-filter" className="text-gray-700 font-semibold">Category:</label>
                <select
                id="category-filter"
          ...
          <div className="flex items-center font-roboto gap-2">
            <label htmlFor="price-filter" className="text-gray-700 text-sm sm:text-base font-semibold">Price:</label>
            <select
              id="price-filter"
              value={priceRange}
              ...
              <div key={product.id} className="transition duration-300 gap-4 p-4 mt-2">
                <div className="flex flex-col justify-between h-full">
                  ...
                  <Link
                    ...
                    className="bg-primary mt-4 text-white hover:bg-white hover:border-2 hover:border-primary hover:text-black w-full p-2 text-center"
                  >
                    View Details
                  </Link>
                </div>
