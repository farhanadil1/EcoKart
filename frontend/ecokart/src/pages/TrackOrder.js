...
const TrackOrder = () => {
  ...
  const promoDiscountAmount = promoApplied ? subtotal * 0.1 : 0;
      ...
      <div>
        ...
        <section className="w-full max-w-7xl mx-auto">
          <div className="font-poppins mx-6 md:mx-10 mt-20 mb-16 text-center">
            <h1 className="text-3xl font-semibold text-[#0d2d1e] mb-6">
              Track Your Order
            </h1>
    ...
    <div>
      ...
      <section className="w-full max-w-7xl mx-auto">
        <div className="font-poppins mx-6 md:mx-10 mt-10 mb-16">
          <h1 className="text-4xl font-bold text-[#0d2d1e] mb-10">
            Track Your Orders
          </h1>
                ...
                <div className="overflow-y-auto custom-scrollbar pr-2 space-y-4 flex-1">
                  <div className="space-y-2 text-sm text-gray-700">
                    <p>
                      ...
                      {orderList[selectedOrderIndex]._id}
                    </p>
                    <p>
                      <strong>Status:</strong>{" "}
                      <span className="text-green-600">
                        {orderList[selectedOrderIndex].status}
                      </span>
                    </p>
                    <p>
                      <strong>Est. Delivery:</strong>{" "}
                      <span className="text-green-600">
                        {deliveryDays[selectedOrderIndex]}
                      </span>
                    </p>
                    <p>
                      <strong>Order Date:</strong>{" "}
                      {formatDateTime(orderList[selectedOrderIndex].createdAt)}
                    </p>
                  </div>
                  ...
                  <div className="border-t pt-4 space-y-1 text-sm text-gray-700">
                    ...
                    <p>
                      <strong>Name:</strong>{" "}
                      {orderList[selectedOrderIndex].shippingDetails.fullName}
                    </p>
                    <p>
                      <strong>Email:</strong>{" "}
                      {orderList[selectedOrderIndex].shippingDetails.email}
                    </p>
                    <p>
                      <strong>Phone:</strong>{" "}
                      {orderList[selectedOrderIndex].shippingDetails.phone}
                    </p>
                    <p>
                      <strong>Address:</strong>{" "}
                      {orderList[selectedOrderIndex].shippingDetails.address},{" "}
                      {orderList[selectedOrderIndex].shippingDetails.city}
                    </p>
                  </div>
                  ...
                  <div className="border-t pt-4 text-right space-y-1 text-sm text-gray-800">
                    ...
                    <p className="text-green-600">
                      Flat Discount: −₹
                      {baseDiscountAmount?.toFixed(2) || "0.00"}
                    </p>
                    {promoDiscountAmount > 0 && (
                      <p className="text-green-600">
                        Promo Discount: −₹
                        {promoDiscountAmount?.toFixed(2) || "0.00"}
                      </p>
                    )}
                    <p className="text-green-600">
                      Total Discount: −₹{totalDiscount?.toFixed(2) || "0.00"}
                    </p>
