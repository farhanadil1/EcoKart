  ...
  return (
    ...
    <div className="bg-white text-gray-800">
      <section className="relative bg-pageBg text-center py-24 px-6 border-b border-gray-200">
        ...
        >
          Making sustainable living simple, stylish, and accessible for everyone.
        </motion.p>
      </section>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg max-w-3xl mx-auto leading-relaxed text-gray-600">
          At EcoKart, we believe that every action matters. Our mission is to make eco-friendly choices effortless and impactful from reusable essentials to sustainable lifestyle products that shape a greener tomorrow.
        </p>

        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { icon: <FaLeaf />, title: "Eco-Friendly", desc: "Products that respect the planet." },
            { icon: <FaTruck />, title: "Fast Delivery", desc: "Reliable and sustainable shipping." },
            { icon: <FaGlobeAmericas />, title: "Global Vision", desc: "Together for a greener world." },
          ].map((item, idx) => (
            <motion.div
              key={idx}
              whileHover={{ y: -4 }}
            ...
            >
              <div className="flex justify-center mb-4 text-green-600 text-3xl">{item.icon}</div>
      ...
      <section className="px-6 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative border-l-2 border-green-500 ml-6">
            {[
              { year: "2019", title: "The Idea Was Born", desc: "We started with a simple mission: reduce plastic." },
              { year: "2020", title: "EcoKart Launch", desc: "Released 20 sustainable products." },
              { year: "2022", title: "Community Growth", desc: "Reached 50,000 eco-conscious shoppers." },
              { year: "2025", title: "Going Global", desc: "Expanding our green vision worldwide." },
            ].map((step, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                <p className="text-sm font-semibold text-green-600">{step.year}</p>
      ...
      <section className="bg-primary text-white text-center py-16 px-6 rounded-t-3xl">
        <h2 className="text-3xl font-semibold mb-3">Join the EcoKart Movement</h2>
        <p className="max-w-2xl mx-auto mb-6 text-lg opacity-90">
          Let’s make sustainable living the new normal. Shop consciously and inspire others.
        </p>
        <a
          href="/all-products"
