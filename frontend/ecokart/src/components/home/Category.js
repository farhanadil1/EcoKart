...
const category = [
  {
    id: 1,
    img: "/category-skincare.jpg",
    link: "/category/skincare",
    name: "Skincare"
  },
  {
    id: 2,
    img: "/category-household.jpg",
    link: "/category/household",
    name: "Household"
  },
  {
    id: 3,
    img: "/category-babycare.jpg",
    link: "/category/baby care",
    name: "Baby Care"
  },
  {
    id: 4,
    img: "/category-personalcare.jpg",
      ...
      <div className="font-poppins mt-10 px-4 md:px-8 ">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 md:px-4 md:gap-8 gap-2 px-2">
          {category.map((cat) => (
            <div
              key={cat.id}
              className="transition duration-300 gap-4 p-4 mt-2 group"
            >
