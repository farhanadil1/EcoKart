...
const OceanImpact = () => {
  return (
    <div className="relative w-full h-[500px] overflow-hidden text-white">
      ...
      <div className="relative z-10 h-full px-6 py-12 bg-black/40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center h-full">
            ...
            <div className="bg-white text-[#0d2d1e] font-poppins p-6">
              ...
              <p className="text-xs sm:text-sm md:text-md leading-relaxed">
                In 2023, we launched the Ecokart Impact Initiative a pledge to
                restore balance between everyday consumption and environmental
                responsibility. For every product sold, we contribute to the
                recovery of ocean-bound plastic and support efforts that reduce
