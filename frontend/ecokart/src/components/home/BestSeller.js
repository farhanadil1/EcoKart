            ...
            >
              <div className="flex flex-col justify-between h-full">
                <div className="overflow-hidden">
                  ...
                  <p className="text-sm font-poppins text-gray-500 mt-2">
                ...
                <Link to={`/product/${product._id}`}>
                  <button className="bg-primary mt-8 border-[1.5px] border-primary text-white hover:bg-white hover:border-[1.5px] hover:border-primary transition duration-300 hover:text-black w-full p-2">
                    View Details
                  </button>
                </Link>
              </div>
